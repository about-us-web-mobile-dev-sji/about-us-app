import type { CreateSuperAdminIdentityInput } from './CreateSuperAdminIdentityInput.js';
import type { CreateSuperAdminIdentityOutput } from './CreateSuperAdminIdentityOutput.js';
...
export class CreateSuperAdminIdentityUseCase {
  private pending: Promise<CreateSuperAdminIdentityOutput> = Promise.resolve();
  constructor(
    private readonly identities: AuthIdentityRepository,
    private readonly passwords: PasswordEncryptionGateway,
  ) {}
  handle(
    input: CreateSuperAdminIdentityInput,
  ): Promise<CreateSuperAdminIdentityOutput> {
